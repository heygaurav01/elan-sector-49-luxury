...
export const CONTACT_INFO = {
    phone: "+91 9111193575",
    whatsapp: "919111193575",
    phoneDisplay: "+91 9111193575",
    email: "digitaldrivemediaofficial@gmail.com", // Keeping consistent with API
};
...
export const NAV_ITEMS = [
    ...
    { name: "PRICE LIST", href: "#floor-plans" }, // Redirect to floor plans/table usually
